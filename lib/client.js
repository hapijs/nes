...
(function (root, factory) {
    ...
    const parse = function (message) {
        ...
        try {
            ...
            throw new NesError(err, errorTypes.PROTOCOL);
        }
    };
    ...
    const Client = function (url, options) {
        ...
        this._onDisconnectCalled = false;
    ...
    Client.prototype._onDisconnect = function (log) {

        if (!this._onDisconnectCalled) {       // guard against multiple invocation
            this._onDisconnectCalled = true;
            this.onDisconnect(this._willReconnect(), log);
        }
    };
