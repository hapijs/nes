...
(function (root, factory) {
    ...
    Client.prototype.connect = function (options, callback) {
        ...
        if (callback === undefined) {
            return Promisify(Client.prototype.connect, this)(options || {});
        }
    ...
    Client.prototype.disconnect = function (callback) {
        ...
        if (callback === false) { //allow backward compatibility with 6.4.x API
            return Promisify(Client.prototype.disconnect, this)();
        }
    ...
    Client.prototype.request = function (options, callback) {
        ...
        if (callback === undefined) {
            return Promisify(Client.prototype.request, { multiArgs: true, thisArg: this })(options);
        }
    ...
    Client.prototype.message = function (message, callback) {
        ...
        if (callback === undefined) {
            return Promisify(Client.prototype.message, this)(message);
        }
    ...
    Client.prototype.subscribe = function (path, handler, callback) {
        ...
        if (callback === undefined) {
            return Promisify(Client.prototype.subscribe, this)(path, handler);
        }
    ...
    Client.prototype.unsubscribe = function (path, handler, callback) {
        ...
        if (callback === undefined) {
            return Promisify(Client.prototype.unsubscribe, this)(path, handler);
        }
