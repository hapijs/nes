...
(function (root, factory) {
    ...
    Client.prototype._connect = function (options, initial, callback) {
        ...
        ws.onopen = () => {
            ...
            return this._hello(options.auth, (err) => {
                ...
                if (err) {
                    ...
                    return this.disconnect(() => finalize(err));       // Stop reconnection when the hello message returns error
                }
        ...
        ws.onclose = (event) => {
            ...
            const wasRequested = !!this._disconnectListeners;
            this._cleanup();
    ...
    Client.prototype._reconnect = function () {
        ...
        if (this._reconnection.retries < 1) {
            return this.disconnect();               // Clear _reconnection state
        }
